    ...
    <div className="bg-cosmic-gradient min-h-screen flex items-center py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 w-full relative z-10">
        <div className="max-w-md mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center font-display">Create Account</h1>
          <Suspense fallback={<div className="text-center py-8 text-neutral-200">Loading...</div>}>
            <RegisterForm />
          </Suspense>
        </div>
      </div>
